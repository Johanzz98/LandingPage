      ...
      >
        <Toolbar
          sx={{
            ...
            padding: '0 32px 14px',
            borderBottom:
              handleNavbarStyle().backgroundColor === 'white'
                ? '1.2px solid #e4e4e4'
                : 'none',
          }}
        >
          ...
          >
            ...
            >
              <LogoSVG
                color={
                  navbarColor || hover || scrollPosition > 25
                    ? '#111'
                    : '#ffffff'
                } // #111 para negro
                size={logoSize ? '50%' : '50%'}
        ...
        >
          ...
          >
            ...
            <Box sx={{ padding: '24px 0px 0 0px' }}>
              ...
              {selectedLeftMenu === 'tazas' ? (
                <TazasMedio />
              ) : selectedLeftMenu === 'poster' ? (
                <PosterMedio />
              ) : selectedLeftMenu === 'tarjetas' ? (
                <TarjetasMedio />
              ) : selectedLeftMenu === 'poleras' ? (
                <PolerasMedio />
              ) : (
                <Medio />
              )}
          ...
          >
            ...
            {selectedMenu === 'playeras' ? (
              <TazasMedia />
            ) : selectedMenu === 'poster' ? (
              <PosterMedia />
            ) : selectedMenu === 'tarjetas' ? (
              <TarjetasMedia />
            ) : selectedMenu === 'poleras' ? (
              <PolerasMedia />
            ) : (
              <CupMedia />
            )}
